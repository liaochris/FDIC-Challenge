...
sb_percap <- c("est","n1_4","n5_9", "n10_19","n20_49", "n50_99")
...
vars <- c("FIPS", "county", "state", "year", "pop", "jobs", "income_adjinf_percap", "est_percap", "n1_4_percap", "n5_9_percap", 
          ...
          "farm_inc_adjinf_percap", "nonfarm_inc_adjinf_percap", "owner_inc_adjinf_percap", "businessChange",  "onefourChange", "fivenineChange", "cpi_2018")
...
onefour_year <- ifelse(onefourC$year >= 2010, 1, 0)
